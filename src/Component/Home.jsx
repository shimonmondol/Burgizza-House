      ...
      <div>
        <div className="py-8 lg:w-[980px] mx-auto px-4 lg:px-0">
          ...
          <div className="flex flex-wrap gap-10">
            {/* Card 1 */}
            <div className="p-4 bg-green-950 rounded-lg shadow text-sm w-full sm:w-[300px]">
              <img
            ...
            {/* Card 2 */}
            <div className="p-4 bg-gray-500 rounded-lg shadow text-sm w-full sm:w-[300px]">
              <img
                className="rounded-md max-h-40 w-full object-cover"
                src={Pizza}
                alt="Pizza"
            ...
            {/* Card 3 */}
            <div className="p-4 bg-orange-600 rounded-lg shadow text-sm w-full sm:w-[300px]">
              <img
                className="rounded-md max-h-40 w-full object-cover"
                src={Sandwich}
                alt="Sandwich"
            ...
            <p className="text-justify text-xl lg:text-base mt-4">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Necessitatibus aut et labore. Corporis assumenda autem beatae amet
              asperiores, facilis necessitatibus perferendis magnam dolor
              ducimus consectetur architecto consequatur aut cum recusandae!
              Explicabo, cum voluptate praesentium et ipsa nisi ut totam
              eveniet? Iste temporibus distinctio deserunt porro corporis vitae
              laborum quod exercitationem!
            </p>
          </div>
