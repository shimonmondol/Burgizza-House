...
const Home = () => {
  return (
    <div>
      <div>
        <div className="lg:w-[980px] mx-auto lg:px-0">
          {/* Responsive Card Grid */}
          <input type="text" />
          <div className="flex flex-wrap gap-10">
            {/* Card 1 */}
            <div className="p-4 bg-gray-200 text-black rounded-lg shadow text-sm w-full sm:w-[300px]">
              <img
              ...
              <button
                type="button"
                className="bg-gray-700 mt-4 px-6 py-2 font-medium rounded text-white cursor-pointer"
              >
                Order Now
              </button>
            </div>
